      ...
      <section id="projetos" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex gap-2 text-xs font-medium text-gray-500">
              <span className="bg-gray-100 px-2 py-1 rounded">UX Research</span>
              <span className="bg-gray-100 px-2 py-1 rounded">Análise de Sentimentos</span>
            </div>
          </a>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <span className="text-xs font-bold text-yellow-700 tracking-wider uppercase bg-yellow-50 px-3 py-1 rounded-full">Em Avaliação</span>
              <span className="text-gray-400 group-hover:text-[#6193FF] transition-colors">↗</span>
            </div>
            <h3 className="text-xl font-bold mb-3">Monitoramento de Clima Espacial</h3>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              Estruturação de pipeline de dados complexos para detecção de anomalias (Space Weather Guard). Uso de modelos generativos para tradução de eventos técnicos em alertas operacionais de alto nível.
            </p>
            <div className="flex gap-2 text-xs font-medium text-gray-500">
              <span className="bg-gray-100 px-2 py-1 rounded">LLM</span>
              <span className="bg-gray-100 px-2 py-1 rounded">Pipeline de Dados</span>
            </div>
          </a>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3">Triagem Médica com NLP</h3>
            <p className="text-gray-600 mb-6 text-sm leading-relaxed">
              Sistema de triagem inteligente utilizando processamento de linguagem natural (NLP) e Random Forest para otimizar fluxos de atendimento inicial, treinando o modelo com datasets especializados em saúde.
            </p>
            <div className="flex gap-2 text-xs font-medium text-gray-500">
              <span className="bg-gray-100 px-2 py-1 rounded">spaCy</span>
              <span className="bg-gray-100 px-2 py-1 rounded">Random Forest</span>
              <span className="bg-gray-100 px-2 py-1 rounded">Python</span>
            </div>
          </a>
